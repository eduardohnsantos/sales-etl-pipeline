...
set -gx VIRTUAL_ENV 'C:\Users\Eduardo\Documents\workspace\sales-etl-pipeline\.venv'
...
if test -n sales-etl-pipeline-py3.14
    set -gx VIRTUAL_ENV_PROMPT sales-etl-pipeline-py3.14
else
